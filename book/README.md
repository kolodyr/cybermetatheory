...
- Brandon Sanderson — Stormlight Archive (Radiants, Oaths, Spren)

**Identity + philosophy:**
- Dennis E. Taylor — We Are Bob (Bobiverse series)

**Wisdom + rhythm:**
- George S. Clason — The Richest Man in Babylon

**Українська література:**
- Сучасна українська література (для tone, мови, культурного контексту)
...
**Що НЕ робити:**
- Не пояснювати все (show don't tell)
- Не робити героя perfect (Aберкромбі навчив нас)
- Не використовувати tech jargon заради jargon
- Не писати пафосні промови (соборність через дії, не слова)

**Що робити:**
- Діалог для філософії
- Внутрішній монолог для self-criticism
- Короткі manifesto moments
- Конкретні образи (не абстракції)
- Ритм через повторення (обережно)

---

**Створено:** 2026-01-10
**Автор:** Франко (Wizard K)
**Архівіст:** VERD + Claude

*Structure > content. Form > function. Incomplete = valid.*
